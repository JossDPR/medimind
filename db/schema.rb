...
ActiveRecord::Schema[7.1].define(version: 2024_08_29_093604) do
  ...
  create_table "chats", force: :cascade do |t|
    ...
    t.bigint "tutor_patient_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["tutor_patient_id"], name: "index_chats_on_tutor_patient_id"
  ...
  add_foreign_key "chats", "tutor_patients"
